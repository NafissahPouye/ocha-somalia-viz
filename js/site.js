...
var targetCall = $.ajax({ 
    type: 'GET', 
    url: 'https://proxy.hxlstandard.org/data.json?strip-headers=on&force=on&url=https%3A%2F%2Fdocs.google.com%2Fspreadsheets%2Fd%2F14CeZmvRIclVD8ZjejZxDgsA5OHJ8L7f9-9i2C5kh3pk%2Fedit%23gid%3D935073182',
    dataType: 'json',
});

var progressCall = $.ajax({ 
    type: 'GET', 
    url: 'https://proxy.hxlstandard.org/data.json?strip-headers=on&force=on&url=https%3A%2F%2Fdocs.google.com%2Fspreadsheets%2Fd%2F14CeZmvRIclVD8ZjejZxDgsA5OHJ8L7f9-9i2C5kh3pk%2Fedit%23gid%3D0',
    dataType: 'json',
});

var keyfigureTargetCall = $.ajax({ 
    type: 'GET', 
    url: 'https://proxy.hxlstandard.org/data.json?strip-headers=on&force=on&url=https%3A%2F%2Fdocs.google.com%2Fspreadsheets%2Fd%2F14CeZmvRIclVD8ZjejZxDgsA5OHJ8L7f9-9i2C5kh3pk%2Fedit%23gid%3D1820516564',
    dataType: 'json',
});

var keyfigureProgressCall = $.ajax({ 
    type: 'GET', 
    url: 'https://proxy.hxlstandard.org/data.json?strip-headers=on&force=on&url=https%3A%2F%2Fdocs.google.com%2Fspreadsheets%2Fd%2F14CeZmvRIclVD8ZjejZxDgsA5OHJ8L7f9-9i2C5kh3pk%2Fedit%23gid%3D959244210',
    dataType: 'json',
});

var descriptionCall = $.ajax({ 
    type: 'GET', 
    url: 'https://proxy.hxlstandard.org/data.json?strip-headers=on&force=on&url=https%3A%2F%2Fdocs.google.com%2Fspreadsheets%2Fd%2F14CeZmvRIclVD8ZjejZxDgsA5OHJ8L7f9-9i2C5kh3pk%2Fedit%23gid%3D546323230',
    dataType: 'json',
});
